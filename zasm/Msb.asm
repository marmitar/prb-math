    /* "src/Common.sol":27135:27249  contract Msb {... */
  mstore(0x40, 0x80)
  callvalue
  dup1
  iszero
...
sub_0: assembly {
    ...
    tag_2:
      revert(0x00, 0x00)
        /* "src/Common.sol":27154:27247  function run(uint256 x) external pure returns (uint256 result) {... */
    tag_3:
      tag_4
      tag_5
      calldatasize
    ...
    tag_4:
      ...
      return
    tag_7:
        /* "src/Common.sol":27201:27215  uint256 result */
      0x00
        /* "src/Common.sol":27234:27240  msb(x) */
      tag_11
        /* "src/Common.sol":27238:27239  x */
      dup3
      ...
      jump
        /* "src/Common.sol":27234:27240  msb(x) */
    tag_11:
        /* "src/Common.sol":27227:27240  return msb(x) */
      swap3
        /* "src/Common.sol":27154:27247  function run(uint256 x) external pure returns (uint256 result) {... */
      swap2
      pop
    ...
    auxdata: 0xa26469706673582212201958d8bf0d2b29889382b73219351fa907a6c5c319c4fe8deed91ed75100676f64736f6c634300081e0033
}
